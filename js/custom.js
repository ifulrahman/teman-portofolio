...
function openWhatsapp() {
   let phoneNum = "+62 813-1566-9406";
   let text = "Haloo teman portofolio, saya ingin order";
   let url = "https://api.whatsapp.com/send?phone=" + phoneNum + "&text=" + encodeURIComponent(text);
